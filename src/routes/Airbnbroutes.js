...
const { PropertyListing, createPropertyId, updatePropertyById, FindProperty, getAllProperties, getPropertyByFilter } = require("../controller/AirbnbListings.js")
...
router.get("/getFilteredproperties", getPropertyByFilter)
